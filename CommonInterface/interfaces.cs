...
{
  /// <summary>
  /// 2018-05-31 Flashdevelop-5.2.0 AnyPugin より移植
  /// </summary>
  public class ChildFormControlClass
  {
    ...
    public CallPluginCommand callPluginCommand { get; set; }
  }
  ...
  public class ParentFormClass
  {
    ...
    public string ActiveDocumentFilePath { get; set; }
    ...
    //public ToolStripSpringComboBox2 selectedPath { get; set; }
    public ImageList imageList1 { get; set; }
    public ImageList imageList2 { get; set; }
    public ContextMenuStrip contextMenuStrip1 { get; set; }
    public PropertyGrid propertyGrid1 { get; set; }
    public ListView FileView { get; set; }
    public UserControl pluginUI { get; set; }
    public Object settingsObject { get; set; }
    public String settingsXml { get; set; }
    public Dictionary<String,String> settingsDict { get; set; }
    public CallPluginCommand callPluginCommand { get; set; }
  ...
  */
  ...
  public interface IMainForm : IContainerControl, IWin32Window
  {
    ...
    // 追加 Time-stamp: <2019-04-11 16:40:57 kahata>
    void CreateCustomDocument(String tagStr);
    Control OpenCustomDocument(String name, String argStr, Boolean singleton = true);
    Control CreateCustomControl(string path, string file, string option = "");
    void OpenDocument(String tagStr, Boolean singleton = true);
    Control OpenEditableDocument(String org, Encoding encoding, Boolean restorePosition);
    Control OpenEditableDocument(String file, Boolean restorePosition);
    Control OpenEditableDocument(String file);
