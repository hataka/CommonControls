...
public class FDScript 
{
	...
	public static PicturePanel form;// = new PicturePanel(); 
	//public static List<string> previousPicturePanelDocuments;
...
/*
	public static void IntializeSettings()
	{
		...
		previousPicturePanelDocuments = (List<string>)settings.PreviousPicturePanelDocuments;
		form.previousDocuments = previousPicturePanelDocuments;
		form.PopulatePreviousDocumentsMenu();
	}
	
	public static void ParentForm_Closing(object sender, EventArgs e)
	{
		previousPicturePanelDocuments = form.previousDocuments;
	}	
*/
	}
