using CommonInterface.Localization;
using System;
...
namespace CommonInterface.Localization
{
	/// <summary>
	...
	public static class TextHelper
	{
		...
		{
      // 現在実行中のメソッドを呼び出したメソッドの System.Reflection.Assembly を返します
      ...
      if (prefix == "AntPanelApplication") prefix = "FlashDevelop";
