// -*- mode: cs -*-  Time-stamp: <2010-10-30 19:58:28 kahata>
/*================================================================
 * title: 
 * file: NeHeLesson17.cs
 * path: F:\VCSharp\CsGL-cs_graphics_library\NeHeLessons\NeHeLesson17\NeHeLesson17.cs
 * url:  http://localhost/VCSharp/CsGL-cs_graphics_library/NeHeLessons/NeHeLesson17/NeHeLesson17.cs
 * created: Time-stamp: <2010-10-30 19:58:28 kahata>
 * revision: $Id$
 ...
 * link: http://nehe.gamedev.net/data/lessons/lesson.asp?lesson=17
 * description: 
 * This lesson demonstrates using texture mapped quads to display text.
 * You will learn how to read one of 256 different characters 
 * from a 256x256 texture map, and finally, 
 * how to place each character on the screen using pixels rather than units. 
 *================================================================*/
