...
namespace CommonInterface.Helpers
{
    ...
    return false;
        ...
        MessageBox.Show(ex.Message.ToString(), MethodBase.GetCurrentMethod().Name);
      }
    }
      ...
      while (stack.Count > 0)
        ...
        public static Boolean ConfirmOverwrite(String path)
        {
            ...
            {
                String title = " " + "FlashDevelop.Title.ConfirmDialog";
                String message = "PluginCore.Info.FolderAlreadyContainsFolder";
            ...
            {
                String title = " " + "FlashDevelop.Title.ConfirmDialog";
                String message = "PluginCore.Info.FolderAlreadyContainsFile";
                DialogResult result = MessageBox.Show(PluginBase.MainForm, String.Format(message, name, "\n"), title, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
                return result == DialogResult.Yes;
            }
            else return true;
